          ...
          <div className="p-8">
            ...
            <div className="mt-6 text-center">
              <div className="text-sm text-gray-500 flex flex-col space-y-2">
                <p>Demo access:</p>
                <div className="p-3 bg-blue-50 rounded-lg text-gray-600 border border-blue-100">
                  <p>Username: <span className="font-medium text-blue-600">user</span></p>
                  <p>Password: <span className="font-medium text-blue-600">password</span></p>
                </div>
              </div>
            </div>
          </div>
